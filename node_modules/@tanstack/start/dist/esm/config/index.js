...
function withStartPlugins(tsrConfig) {
    return withPlugins([
        config('start-vite', {
            ssr: {
                noExternal: ['@tanstack/start', 'tsr:routes-manifest'],
    ...
    return {
        ...
        async load(id) {
            ...
            routes: {}
                ...
                const clientViteManifestPath = path.resolve(config.build.outDir, '../client/_build/.vite/manifest.json');
                let manifest;
                try {
