...
`
        ...
        const compiled = compilers.compileCreateServerFnOutput({
          code,
          root: ROOT,
          filename: id
        });
...
exports.TanStackStartVite = TanStackStartVite;
exports.TanStackStartViteCreateServerFn = TanStackStartViteCreateServerFn;
